...
public class FeedPreferences implements Serializable {
    ...
    public FeedPreferences(long feedID, AutoDownloadSetting autoDownload, boolean keepUpdated,
                            ...
                            boolean freshestOnly, Set<String> tags) {
        this.feedID = feedID;
        ...
        this.freshestOnly = freshestOnly;
    ...
    public boolean isFreshestOnly() {
        return freshestOnly;
    }

    public void setFreshestOnly(boolean freshestOnly) {
        this.freshestOnly = freshestOnly;
    }
}
