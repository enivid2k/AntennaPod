...
public class PodDBAdapter {
    ...
    public static final String KEY_FRESHEST_ONLY = "freshest_only";
    ...
    private static final String CREATE_TABLE_FEEDS = "CREATE TABLE " + TABLE_NAME_FEEDS + " ("
            ...
            + KEY_FRESHEST_ONLY + " INTEGER DEFAULT 0)";
    ...
    private static final String KEYS_FEED =
            ...
            + TABLE_NAME_FEEDS + "." + KEY_FRESHEST_ONLY;
    ...
    private static final String WHERE_FRESHEST_ONLY =
            "(" + TABLE_NAME_FEED_ITEMS + "." + KEY_FEED
            + " NOT IN (SELECT " + KEY_ID + " FROM " + TABLE_NAME_FEEDS
            + " WHERE " + KEY_FRESHEST_ONLY + " = 1)"
            + " OR " + TABLE_NAME_FEED_ITEMS + "." + KEY_PUBDATE
            + " = (SELECT MAX(t." + KEY_PUBDATE + ") FROM " + TABLE_NAME_FEED_ITEMS + " t"
            + " WHERE t." + KEY_FEED + " = " + TABLE_NAME_FEED_ITEMS + "." + KEY_FEED + "))";
    ...
    public void setFeedPreferences(FeedPreferences prefs) {
        ...
        values.put(KEY_FRESHEST_ONLY, prefs.isFreshestOnly());
    ...
    public final Cursor getEpisodesCursor(int offset, int limit, FeedItemFilter filter, SortOrder sortOrder) {
        String orderByQuery = FeedItemSortQuery.generateFrom(sortOrder);
        String filterQuery = FeedItemFilterQuery.generateFrom(filter);
        String whereClause = "".equals(filterQuery)
                ? " WHERE " + WHERE_FRESHEST_ONLY
                : " WHERE " + filterQuery + " AND " + WHERE_FRESHEST_ONLY;
